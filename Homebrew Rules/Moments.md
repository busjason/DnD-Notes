...
- The party is trying to rescue people from a group of slavers. The party knows the slavers have a temporary holding camp that has limited guards during the afternoon hours. The party needs to get in find and free the slaves and get out before dusk or the raiding groups will return during their rescue. So the defined time for the scene is from the beginning until dusk. It really doesn't matter how long exactly that is we just know it will be dusk when all 5 moments have been used. This creates tension and decision making during the game.

- The adventurers are exploring ancient ruins we break the adventuring day into three time chunks morning to mid-day, mid-day to night, and night to morning. Each time chunk contains lets say 5 moments. Now we can easily keep track of how long it takes for the party to navigate the dungeon.

- Our group of heroes is travelling across the country to their next location. They plan their trip and it is going to take two weeks of travel. Lets say we divide the whole trip into 2 moment pools of 5 moments each. Yes that means a long rest takes essentially a week and to be honest it makes some sense to me. It also means that each night is not an instant reset the party has to use their resourcefuless to travel but it hopefully feels more like a game and not a terrible slog. 

### Player actions during a moment

#### Actions during a short moment scope.
###### Like the slavers or the dungeon example above.
- Transitions from one scene to another.
- Short rests.
- Chases.
- Picking a lock.
- Scaling a cliff.
- Stealthily moving / Scouting ahead.
- Casting a long casting time spell.
- Searching for something.
- Interrogations / Conversations.
- Tracking a quarry.
- Helping somebody take a moment action.
- Reading a book.
- Preparing spells.
- Maintaining warn equipment (see Wear and Tear).


#### Actions during a long moment scope.
###### Like the overland travel example.

- Transitions from one scene to another.
- Short rests.
- Chases.
- Bypassing a wilderness hazard.
- Stealthily moving / Scouting ahead.
- Casting a really long casting time spell.
- Searching for something.
- Tracking a quarry.
- Helping somebody take a moment action.
- Reading books.
- Foraging for food and water.
- Preparing a kill such as skinning a large beast.
- Spend time toward learning a language or skill.
